...
create table public.raffles (
  ...
  pack_prices jsonb not null default '{"single":{"quantity":1,"price":20},"popular":{"quantity":3,"price":50},"value":{"quantity":7,"price":100}}',
...
create table public.orders (
  ...
  quantity integer not null check (quantity in (1,3,7)),
